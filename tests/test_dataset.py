...
def test_filter_by_minute():
    ...
    minute_to_filter = 40
    df = dataset.filter_by_minute(minute=minute_to_filter, datetime_column="date_time")
    assert len(df) == 8
...
def test_filter_by_hour():
    ...
    hour_to_filter = 16
    df = dataset.filter_by_hour(hour=hour_to_filter, datetime_column="date_time")
    assert len(df) == 38
...
def test_filter_by_week():
    ...
    week_to_filter = 37
    df = dataset.filter_by_week(week=week_to_filter, datetime_column="date_time")
    assert len(df) == 38
...
def test_filter_by_month():
    ...
    month_to_filter = 9
    df = dataset.filter_by_month(month=month_to_filter, datetime_column="date_time")
    assert len(df) == 38
...
def test_filter_by_year():
    ...
    year_to_filter = 2022
    df = dataset.filter_by_year(year=year_to_filter, datetime_column="date_time")
    assert len(df) == 38
